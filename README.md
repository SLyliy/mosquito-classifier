...
The repository also includes the dataset folders used for the classification experiments.
...
This folder contains the mosquito image dataset organized by species and condition, together with the `data_splitting` folder used in the classification experiments.
...
This file provides the project overview, dataset structure, methodology summary, and usage instructions.
